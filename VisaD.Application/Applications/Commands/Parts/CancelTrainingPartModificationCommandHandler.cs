...
{
	public class CancelTrainingPartModificationCommandHandler : CancelPartModificationCommandHandler<ApplicationCommit, TrainingPart, Training>
	{
		public CancelTrainingPartModificationCommandHandler(IAppDbContext context)
			: base(context)
		{
		}
